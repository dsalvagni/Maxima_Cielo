...
class Maxima_Cielo_Model_WebServiceOrder
{
	...
	function __construct($params)
	{
		...
		$baseURL 			= Mage::getStoreConfig('payment/Maxima_Cielo_Cc/environment');
		Mage::log($baseURL);
		...
		Mage::log('URL: '.$this->_webServiceURL);
	...
	{
		Mage::log('SendRequest: '. $postMsg);
		Mage::log('Transação: '. $transacao);
		...
		Mage::log('Response: '.$this->_xmlResponse);
